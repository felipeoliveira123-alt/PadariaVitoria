...
<head>
    ...
    <link href="app\public\css\bootstrap-5.3.5-dist\css\bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="app\public\css\bootstrap-5.3.5-dist\css\estilo.css">
    <link rel="icon" type="image/png" href="app/public/images/Logotipo.png?v=1">
</head>
<body>

    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <form class="p-4 p-md-5 border rounded-3 bg-light shadow-sm formulariologin" action="app\views\login.php" method="POST">
            <div class="text-center mb-4">
                <img src="app/public/images/Logotipo.png" class="img-fluid imagemLogotipoPadaria" alt="Logo da Padaria">
            </div>
            ...
            <a href="app\views\cadastro_usuario\cadastro.php" class="btn btn-primary">Cadastre-se</a>

            <div id="esqueceuSenha" class="mt-3" style="<?= $erroLogin ? 'display:block;' : 'display:none;' ?>">
                <a href="app\views\recuperacao_senha\Recuperacao.php">Esqueceu sua senha?</a>
            </div>
...
<body>
    ...
    <script src="app\public\css\bootstrap-5.3.5-dist\js\bootstrap.bundle.min.js"></script>
</body>
</html>